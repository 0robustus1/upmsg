...
Since timestamps (as long as there are activated) only show sceonds.nanoseconds, there not very human-readable.
...
There is also a daemon mode which notifies you using libnotify and your installed notification-daemon. Everytime an event happens you will be notified. (in you gui in a nice little bubble)
...
Now you just copy the script in a place in your PATH, preferably in _/usr/bin_
